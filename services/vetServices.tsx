...
export class VeterinaryService {
  static updateVeterinary = async (
    ...
    try {
      ...
      throw new Error("VeterinaryService: No se pudo actualizar el perfil de la veterinaria.");
    }
  };

  static createVeterinary = async (formData: FormData): Promise<any> => {
    try {
      const { data } = await axiosInstanceSpikeCore.post("/createVeterinary", formData, {
      ...
      throw new Error("VeterinaryService: No se pudo completar el registro de la veterinaria.");
    }
  };
  ...
  static getCitasVet = async (vetId: number): Promise<any> => {
    try {
      const { data } = await axiosInstanceSpikeCore.post("/citasVet", { vetId });
      return data;
    } catch (error) {
      ...
      throw new Error("VeterinaryService: No se pudo obtener las citas de la veterinaria.");
    }
  };
  ...
  static cancelarCita = async (appointmentId: number) => {
    try {
      const { data } = await axiosInstanceSpikeCore.post(`/cancelarCita`, { appointmentId });
      return data;
    } catch (error) {
  ...
  static marcarCitaCompletada = async (appointmentId: number) => {
    try {
      const { data } = await axiosInstanceSpikeCore.post(`/citaCompletada`, { appointmentId });
      return data;
    } catch (error) {
