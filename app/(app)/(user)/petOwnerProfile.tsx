      ...
      <ScrollView>
        <View style={styles.container}>
          <TouchableOpacity onPress={handleImagePick}>
            <Image
              source={formData.img ? { uri: formData.img } : require("@/assets/images/catbox.png")}
          ...
          <TouchableOpacity onPress={() => router.push("/petlist")} style={styles.optionButton}>
...
const styles = StyleSheet.create({
  ...
  optionButton: { flexDirection: 'row', justifyContent: 'space-between', width: '100%', padding: 15, borderBottomWidth: 1 },
  optionText: { fontSize: 18 },
  saveButton: { backgroundColor: '#007BFF', padding: 15, marginVertical: 20, borderRadius: 10 },
